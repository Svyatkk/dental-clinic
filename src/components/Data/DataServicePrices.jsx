export const infoServicePages = [
    ...
    },
    {
        ...
        'Синусліфтінг відкритий + 0.5 байос': 25000,
        'Синусліфтінг закритий': 7000,
        'Аугментація': 6000,
        'Імплантація': 8000,
        'Імплант BICON': 22000
    },
    {
        ...
        'Ігрова адаптація до лікування 30 хв.': 500,
        'Дитяча чистка зубів ротаційною щіткою + паста': 700,
        'Кольорова пломба (компомер)': 1200,
        'Фотополімерна пломба молочний зуб': 1300,
        'Пломба зі стіклоіномерного цемента молочний зуб': 900,
